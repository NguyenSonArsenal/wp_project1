    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shop01.png" alt="">
                    </div>
                    <div class="shop-body">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shop03.png" alt="">
                    </div>
                    <div class="shop-body">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/shop02.png" alt="">
                    </div>
                    <div class="shop-body">
